...
using namespace std;
const char *nombe_archivo = "listado.dat";
...
void buscar_codigo(){
	...
	cout<<"Cual codigo estara visible para ver : ";
	cin>>cod;
...
void ingresar_estudiante(){
	...
	FILE* archivo = fopen(nombe_archivo, "ab"); 
		...
		cout<<"Permitiras agregrar otro Nombre s/n : ";
		cin>>continuar;
...
void modificar_estudiante(){
	...
	FILE* archivo = fopen(nombe_archivo, "r+b");
		...
		cout << "Escribe el ID que deseas modificar: ";
    	cin >> id;
